...
<nav className="navbar navbar-expand-lg bg-dark" style={{fontFamily:"Montserrat"}}>
  ...
  <a className="navbar-brand"><Link to="/" className="text-white" className="navText" href="">Inicio</Link></a>
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
        <a className="nav-link"><Link to="/popular" className="nav-link " className="navText" href="#">Popular</Link></a>
        </li>
      </ul>
